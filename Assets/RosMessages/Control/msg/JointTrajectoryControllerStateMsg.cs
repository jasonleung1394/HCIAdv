...
namespace RosMessageTypes.Control
{
    ...
    public class JointTrajectoryControllerStateMsg : Message
    {
        ...
        public JointTrajectoryControllerStateMsg(Std.HeaderMsg header, string[] joint_names, Trajectory.JointTrajectoryPointMsg desired, Trajectory.JointTrajectoryPointMsg actual, Trajectory.JointTrajectoryPointMsg error, string[] multi_dof_joint_names, Trajectory.MultiDOFJointTrajectoryPointMsg multi_dof_desired, Trajectory.MultiDOFJointTrajectoryPointMsg multi_dof_actual, Trajectory.MultiDOFJointTrajectoryPointMsg multi_dof_error)
        {
            this.header = header;
