...
public class FrankaPanda_f_reverse : MonoBehaviour
{
    ...
    void Start()
    {
		...
		Base = GameObject.Find("pandaAnimator");
        J1 = GameObject.Find("Panda_J1_an");
        J2 = GameObject.Find("Panda_J2_an");
        J3 = GameObject.Find("Panda_J3_an");
        J4 = GameObject.Find("Panda_J4_an");
        J5 = GameObject.Find("Panda_J5_an");
        J6 = GameObject.Find("Panda_J6_an");
        J7 = GameObject.Find("Panda_J7_an");
		TCP  = GameObject.Find("TCP_fingers_an");
		finger1  = GameObject.Find("finger1_an");
		finger2  = GameObject.Find("finger2_an");
