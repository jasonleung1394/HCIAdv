...
public class OffsetValue : MonoBehaviour
{
    ...
    [Range(0f,90f)]
    public float arm_yaw = 0f;

    [Range(0f,90f)]
    public float arm_pitch = 0f;

    [Range(0f,90f)]
    public float arm_roll = 0f;

    [Range(0f,90f)]
    public float forearm_pitch = 0f;

    [Range(0f,90f)]
    public float forearm_roll = 0f;
